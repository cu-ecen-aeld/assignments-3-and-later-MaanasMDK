...
* Description : C file to write a given string of text into a file.
* Date : 01/29/2023
* References : Man pages and Week2 lectures
************************************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <syslog.h>
...
int main(int argc, char *argv[])
{
	...
	fd = open( filename, O_WRONLY | O_CREAT | O_TRUNC, S_IWUSR | S_IRUSR | S_IWGRP | S_IRGRP | S_IROTH | S_IWOTH );
